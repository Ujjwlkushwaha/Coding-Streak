...
{
    Solution s;
    cout << s.longestDiverseString(1, 1, 7) << endl; // Output: "aaabbc"
    cout << s.longestDiverseString(2, 2, 1) << endl; // Output: "aab"
    cout << s.longestDiverseString(7, 1, 0) << endl; // Output: "aaabbbccc"
    return 0;
}